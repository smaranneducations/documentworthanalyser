      ...
      <div className="mx-auto max-w-7xl w-full px-6 py-16">
        ...
        <div className="rounded-2xl bg-zinc-900/60 border border-zinc-800/60 p-4 print-no-break">
          ...
          <div className="grid grid-cols-3 md:grid-cols-5 gap-2">
            ...
            <ClassificationBadge label="Manipulation" value={r.forensics.deception.manipulation_index > 55 ? "High" : r.forensics.deception.manipulation_index > 35 ? "Medium" : "Low"} scoreLabel={`${r.forensics.deception.manipulation_index}/100`} tooltip={tip("manipulation_index")} />
            <ClassificationBadge label="Fluff Score" value={r.forensics.fluff.fluff_score > 70 ? "High" : r.forensics.fluff.fluff_score > 40 ? "Medium" : "Low"} scoreLabel={`${r.forensics.fluff.fluff_score}/100`} tooltip={tip("fluff_score")} />
            <ClassificationBadge label="Bias" value={r.bias_detection.overall_bias_score > 50 ? "High" : r.bias_detection.overall_bias_score > 25 ? "Medium" : "Low"} scoreLabel={`${r.bias_detection.overall_bias_score}/100`} tooltip={tip("overall_bias_score")} />
